...
public class ViewMenu extends Menu {
    public ViewMenu(PlayerMenuUtility playerMenuUtility, Trivia trivia, QuestionHolder questionHolder, ChatEvent chatEvent) {
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        if (type == Material.GREEN_TERRACOTTA) {
            ...
            new ListMenu(trivia.getPlayerMenuUtility(player), trivia, questionHolder, chatEvent).open();
            return;
    ...
    public void setMenuItems() {
        insertItem(Material.GREEN_TERRACOTTA, "Question", playerMenuUtility.getQuestion().getQuestionString(), 11);
        insertItem(Material.YELLOW_TERRACOTTA, "Answer", playerMenuUtility.getQuestion().getAnswerString(), 13);
