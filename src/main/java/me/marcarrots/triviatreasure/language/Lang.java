...
public enum Lang {
    ...
    COMMANDS_ERROR_SKIP_NOT_ALLOWED("Commands.errors.skip_not_allowed", "&cFailed to skip round. Reason:Skip request made in-between rounds."),
    ...
    COMMANDS_HELP_REWARDS("Commands.help.rewards", " rewards &7- &fOpens up rewards menu to modify rewards for winners."),
    COMMANDS_HELP_QUESTIONS("Commands.help.questions", " questions &7- &fOpens up questions menu to create/update questions or answers."),
